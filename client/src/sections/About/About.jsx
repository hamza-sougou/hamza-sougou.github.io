        ...
        <div className="flex flex-col lg:flex-row w-full h-auto justify-center items-center">
          <div className="flex-1 flex justify-center items-center h-auto">
            <img
              src={Me}
              alt="Me"
              className="w-full md:w-[35vw] h-[35rem] object-cover"
            />
          </div>
          <div className="flex-1 flex w-[90%] md:w-full p-5 md:h-[15rem] bg-[#ffe1c5] dark:bg-[#101010] shadow -mt-7 md:mt-0 md:-ml-[3rem]">
